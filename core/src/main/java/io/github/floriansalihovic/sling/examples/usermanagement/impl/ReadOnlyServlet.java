 ...
 */
@SlingServlet(methods = {"GET"}, resourceTypes = {"sling:Folder"}, selectors = {"readonly"})
public class ReadOnlyServlet extends AbstractAclServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        userManagerService.resourceIsReadOnlyFor(resourceResolver, resource, getPrincipalName(request));
